...
<div id="main-content-wp" class="home-page">
    <div id="slider-wp">
        <div class="item">
            <img src="${pageContext.request.contextPath}public/images/img-slider-01.png" alt="">
        </div>
        <div class="item">
            <img src="${pageContext.request.contextPath}public/images/img-slider-01.png" alt="">
        </div>
            ...
            <div class="section-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        ...
                        <div class="icon fl-right"><i class="fa fa-gift" aria-hidden="true"></i></div>
                    </li>
                    <li>
                ...
                <ul class="list-item clearfix">
                    <li>
                        <a href="?page=detail_product" title="" class="thumb">
                            <img src="${pageContext.request.contextPath}public/images/img-product-01.png" alt="">
                        </a>
                        <div class="info">
                    ...
                    <li>
                        <a href="?page=detail_product" title="" class="thumb">
                            <img src="${pageContext.request.contextPath}public/images/img-product-02.png" alt="">
                        </a>
                        <div class="info">
                    ...
                    <li>
                        <a href="?page=detail_product" title="" class="thumb">
                            <img src="${pageContext.request.contextPath}public/images/img-product-03.png" alt="">
                        </a>
                        <div class="info">
                    ...
                    <li>
                        <a href="?page=detail_product" title="" class="thumb">
                            <img src="${pageContext.request.contextPath}ublic/images/img-product-04.png" alt="">
                        </a>
                        <div class="info">
        ...
        <div class="wp-inner">
            ...
            <div class="section-detail">
                <ul class="list-item clearfix">
                    ...
                    <li>
                        <a href="" title="" class="thumb">
                            <img src="${pageContext.request.contextPath}public/images/img-product-04.png" alt="">
                        </a>
                        <div class="info">
                            <a href="" title="" class="name-product">T-Shirt For Girl</a>
                            <div class="price-wp">
            ...
            <div class="section-detail">
                <div id="blog-list">
                    <ul class="list-item">
                        <li class="item">
                            <a href="" title="" class="thumb">
                                <img src="${pageContext.request.contextPath}public/images/img-news-01.png" alt="">
                            </a>
                        ...
                        <li class="item">
                            <a href="" title="" class="thumb">
                                <img src="${pageContext.request.contextPath}public/images/img-news-02.png" alt="">
                            </a>
                            <a href="" title="" class="title">Cách phối màu quần áo phù hợp với từng sắc tố da</a>
                            <p class="desc">Lorem Ipsum chỉ đơn giản là một đoạn văn bản giả, được dùng vào việc trình bày và dàn trang phục vụ cho in ấn. Lorem Ipsum đã được sử dụng như một văn bản chuẩn cho ngành công nghiệp in ấn từ những năm 1500</p>
                        </li>
